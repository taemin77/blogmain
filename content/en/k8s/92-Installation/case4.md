...
---
title: "Case 4. OS(windows) + Network(Bridge Mode) + 가상화(VirtualBox-CentOS) + k8s(v1.19.4)"
linkTitle: "설치 Case 4"
weight: 3
date: 2021-08-02
description: > 
  ...
  <br/>
  VM 생성시 노트북에 연결되어 있는 공유기로부터 IP를 할당 받을 수 있을 경우의 설치 방법입니다.
---

<figure>
  <img src="/img/practice/appendix/Setting VirtualBox for Kubernetes.jpg"
